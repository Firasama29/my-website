  ...
  return (
    <section id="projects" className="py-20">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-slate-500 mb-10">Things I&apos;ve built</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div
              key={project.name}
              className="bg-white border border-slate-100 rounded-xl shadow-sm p-6 flex flex-col hover:shadow-md hover:border-blue-100 transition-all"
            >
